...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName) {
        ...
        try{
            ...
            double temperatureInC = (double) temperatureData.get(index);
            double temperatureinF = (temperatureInC * 1.8) + 32;
            int temperature = (int) Math.round(temperatureinF);
            ...
            int windspeed = (int) Math.round(windspeedMph);

            // build the weather json data object that is going to access the frontend
    ...
    public static String getCurrentTime() {
        ...
        // format date to be 2024-06-20T00:00 (this is how it is read in the API)
